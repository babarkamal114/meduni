...
import { LEARNING_CARDS, WEEKLY_MATERIALS } from '@/lib/mock/learning';

const contentHref = (id: string) => `/dashboard/learning/content/${id}`;
...
export default function DashboardLearningPage(): React.ReactElement {
  return (
